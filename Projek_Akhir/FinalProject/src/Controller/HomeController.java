 ...
 * @author Ryzal
 */
public class HomeController implements rController{
    ...
    public void getData(HomeView view) {
        ...
        view.getLabelNop().setText(nopol);
        view.getfMerk1().setText(merk);
        view.getfType1().setText(type);
        view.getfTahun1().setText(tahun);
        view.getfHarga1().setText(harga);
...
//                view.reset();
    ...
    public void updateMotor(HomeView view) throws SQLException {
        try {
            String nopol = view.getLabelNop().getText();
            String merk = view.getfMerk1().getText();
            String type = view.getfType1().getText();
            String tahun = view.getfTahun1().getText();
            String harga = view.getfHarga1().getText();
...
//                    view.resetFormSewa();
    ...
    @Override
    public void resetForm(HomeView view) {
        view.reset();
    }

    @Override
    public void resetFormSewa(HomeView view) {
        view.resetFormSewa();
    }
}
